 ...
 * @property {number} mu - drift parameter for the GBM price simulation
 * @property {number} sigma - volatility parameter for the GBM price simulation
 * @property {boolean} isShariaCompliant
 */
